...
namespace Review
{
    class Program
    {
        ...
        {
            /* Simple script that takes Lyrics and Censor swearing and bad words returning a New Clean Version */
            ...
            //Create New Clean Lyrics replacing the Censor Words in Lyrics with XXX
            string NewCleanLyrics = lyrics50Cent.Replace(censorWord1, "***");
            NewCleanLyrics = NewCleanLyrics.Replace(censorWord2, "***");
            NewCleanLyrics = NewCleanLyrics.Replace(censorWord3, "***");
